...
$dynamicList_xbox = "";
$sql_pc = "SELECT * FROM products WHERE subcategory='PC' ORDER BY date_added DESC LIMIT 20";
...
$dynamicList_ps3 = "";
$sql_ps3 = "SELECT * FROM products WHERE subcategory='PS3' ORDER BY date_added DESC LIMIT 20";
...
$dynamicList_xbox360 = "";
$sql_xbox360  = "SELECT * FROM products WHERE subcategory='Xbox360' ORDER BY date_added DESC LIMIT 20";
  ...
  <?php include_once("template_header.php");?>
    ...
    <div class="large-4 small-12 columns">
        <div class="hide-for-small panel">
          <h3>Products page</h3>
        <h5 class="subheader">
		  Here you can see all the available products we have to offer.</h5>
        </div>
	...
	{
		echo  "<h3>PC products list:</h3>";
		echo $dynamicList_pc;
		}
	
	
	if(isset($_GET['xbox360']))
{		
		echo  "<h3 class=\"subheader\">Xbox360 products list:</h3>";
		echo $dynamicList_xbox360;
		}
	
	
	if(isset($_GET['ps3']))
		{
		echo  "<h3>PS3 products list:</h3>";
		echo $dynamicList_ps3;
		}
	?>
